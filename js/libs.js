...
$('#togler-button').click(function(){
    ...
    ["О нас", "About us"],
    ["Контакты", "Contacts"],
    ["разработка и", "development and"],
    ["продвижение сайтов", "promotion of sites"],
    ["Мы любим то, что делаем, получаем удовольствие от каждого проекта.", 
    "We love, what we do, and enjoy every project."],
    ["Мы создаем современные, оригинальные и смелые сайты.", 
    "We create up-to-date, original and ambitious sites."],
    ["Далее", "Next"],
    ...
    ["About us", "О нас"],
    ["Contacts", "Контакты"],
    ["development and", "разработка и"],
    ["promotion of sites", "продвижение сайтов"],
    ["We love, what we do, and enjoy every project.", 
    "Мы любим то, что делаем, получаем удовольствие от каждого проекта."],
    ["We create up-to-date, original and ambitious sites.",
    "Мы создаем современные, оригинальные и смелые сайты."],
